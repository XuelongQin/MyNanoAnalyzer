...
file3 = 0
if (args.year !="Run2"):
    file=ROOT.TFile("./Histo/HistoCR_{}/Taug2_mutau_{}.root".format(args.year,args.year),"r")
else:
    file=ROOT.TFile("./Histo/HistoCR_{}/Taug2_mutau_{}.root".format("2016pre","2016pre"),"r")
    file1=ROOT.TFile("./Histo/HistoCR_{}/Taug2_mutau_{}.root".format("2016post","2016post"),"r")
    file2=ROOT.TFile("./Histo/HistoCR_{}/Taug2_mutau_{}.root".format("2017","2017"),"r")
    file3=ROOT.TFile("./Histo/HistoCR_{}/Taug2_mutau_{}.root".format("2018","2018"),"r")
