if __name__ == "__main__":
    ...
    fVV=ROOT.TFile("Histo/HistoCR3_anti_"+options.year+"/VV.root","r")
    fTT=ROOT.TFile("Histo/HistoCR3_anti_"+options.year+"/TT.root","r")
    fST=ROOT.TFile("Histo/HistoCR3_anti_"+options.year+"/ST.root","r")
    fZLL=ROOT.TFile("Histo/HistoCR3_anti_"+options.year+"/ZLL.root","r")
    fZTT=ROOT.TFile("Histo/HistoCR3_anti_"+options.year+"/ZTT.root","r")
    fData=ROOT.TFile("Histo/HistoCR3_anti_"+options.year+"/SingleMuon.root","r")
    fout=ROOT.TFile("Histo/HistoCR3_"+options.year+"/Fake.root","recreate")
    ncat=1
    cate = ["mt_3"]
    year4=options.year
