...
file3 = 0
if (args.year !="Run2"):
    file=ROOT.TFile("./Histo/HistoCR45_{}/Taug2_mutau_{}.root".format(args.year,args.year),"r")
else:
    file=ROOT.TFile("./Histo/HistoCR45_{}/Taug2_mutau_{}.root".format("2016pre","2016pre"),"r")
    file1=ROOT.TFile("./Histo/HistoCR45_{}/Taug2_mutau_{}.root".format("2016post","2016post"),"r")
    file2=ROOT.TFile("./Histo/HistoCR45_{}/Taug2_mutau_{}.root".format("2017","2017"),"r")
    file3=ROOT.TFile("./Histo/HistoCR45_{}/Taug2_mutau_{}.root".format("2018","2018"),"r")
...
if (args.year == "Run2"):
    ...
    ZLL.Add(file1.Get(args.channel).Get("ZLL").Clone())
    ZLL.Add(file2.Get(args.channel).Get("ZLL").Clone())
    ZLL.Add(file3.Get(args.channel).Get("ZLL").Clone())
...
S = GGTT.Integral()
categ  = ROOT.TPaveText(0.65, 0.5+0.013, 0.83, 0.50+0.155, "NDC")
...
c.Modified()
c.SaveAs("Plotsmutau/"+args.year+"CR/control_"+args.variable+args.channel+".pdf")
c.SaveAs("Plotsmutau/"+args.year+"CR/control_"+args.variable+args.channel+".png")