...
python3 Gethisto_SR_shape.py 2016pre GGToMuMu GGMM
...
python3 Gethisto_SR_shape.py 2016pre VV2L2Nu VV
python3 Gethisto_SR_shape.py 2016pre ZZ2Q2L VV
python3 Gethisto_SR_shape.py 2016pre ZZ4L VV
hadd -f Histo/HistoSR_2016pre/VV.root Histo/HistoSR_2016pre/WZ2Q2L.root Histo/HistoSR_2016pre/WZ3LNu.root Histo/HistoSR_2016pre/VV2L2Nu.root Histo/HistoSR_2016pre/ZZ2Q2L.root Histo/HistoSR_2016pre/ZZ4L.root
