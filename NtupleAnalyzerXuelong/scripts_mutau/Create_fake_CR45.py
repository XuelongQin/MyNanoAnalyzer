if __name__ == "__main__":
    ...
    fVV=ROOT.TFile("Histo/HistoCR45_anti_"+options.year+"/VV.root","r")
    fTT=ROOT.TFile("Histo/HistoCR45_anti_"+options.year+"/TT.root","r")
    fST=ROOT.TFile("Histo/HistoCR45_anti_"+options.year+"/ST.root","r")
    fZLL=ROOT.TFile("Histo/HistoCR45_anti_"+options.year+"/ZLL.root","r")
    fZTT=ROOT.TFile("Histo/HistoCR45_anti_"+options.year+"/ZTT.root","r")
    fData=ROOT.TFile("Histo/HistoCR45_anti_"+options.year+"/SingleMuon.root","r")
    fout=ROOT.TFile("Histo/HistoCR45_"+options.year+"/Fake.root","recreate")
    ncat=2
    cate = ["mt_4","mt_5"]
    year4=options.year
