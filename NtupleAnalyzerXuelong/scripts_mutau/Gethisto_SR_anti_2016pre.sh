...
python3 Gethisto_SR_anti.py 2016pre DY ZLL
...
python3 Gethisto_SR_anti.py 2016pre VV2L2Nu VV
python3 Gethisto_SR_anti.py 2016pre ZZ2Q2L VV
python3 Gethisto_SR_anti.py 2016pre ZZ4L VV
hadd -f Histo/HistoSR_anti_2016pre/VV.root Histo/HistoSR_anti_2016pre/WZ2Q2L.root Histo/HistoSR_anti_2016pre/WZ3LNu.root Histo/HistoSR_anti_2016pre/VV2L2Nu.root Histo/HistoSR_anti_2016pre/ZZ2Q2L.root Histo/HistoSR_anti_2016pre/ZZ4L.root
...
python3 Gethisto_SR_anti.py 2016pre SingleMuonB data_obs
python3 Gethisto_SR_anti.py 2016pre SingleMuonC data_obs
python3 Gethisto_SR_anti.py 2016pre SingleMuonD data_obs
python3 Gethisto_SR_anti.py 2016pre SingleMuonE data_obs
python3 Gethisto_SR_anti.py 2016pre SingleMuonF data_obs
hadd -f Histo/HistoSR_anti_2016pre/SingleMuon.root Histo/HistoSR_anti_2016pre/SingleMuonB.root Histo/HistoSR_anti_2016pre/SingleMuonC.root Histo/HistoSR_anti_2016pre/SingleMuonD.root Histo/HistoSR_anti_2016pre/SingleMuonE.root Histo/HistoSR_anti_2016pre/SingleMuonF.root
