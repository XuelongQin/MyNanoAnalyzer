...
#pragma link C++ function GetFR_mutau_qcd GetFR_mutau_w GetFR_mutau_qcd_sys_taupt GetFR_mutau_w_sys_taupt GetFR_mutau_qcd_sys_ntrk_dm GetFR_mutau_w_sys_ntrk_dm GetFR_mutau;
