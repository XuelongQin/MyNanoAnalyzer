...
// all functions
#pragma link C++ function Getmutauindex Gettautauindex GetLepVector GetSFweight_mutau Getxsweight_W GetSFweight_tautau GetisOS Getis_isolated TMass_F Getisfid GetTransmass GetCollMass GetAcopl GeteeSF Get_tausfcor_mutau Get_tausfcor_tautau;
...
#pragma link C++ function Gettauidsysweight_dm Gettauidsysweight Getpusysweight Getditautrigweight Gettauessys Gettauantimusysweight Getmutautrgweight Getsinglemutrgweight GetL1PrefiringWeight Getmusysweight GeteeSFsysweight GetPSsysweight GetPDFsysweight GetScalesysweight;
#endif