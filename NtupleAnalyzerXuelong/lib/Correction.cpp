...
TFile* f_aco_fine=new TFile("/afs/cern.ch/work/x/xuqin/taug-2/nanoAOD/CMSSW_12_4_2/src/MyNanoAnalyzer/NtupleAnalyzerXuelong_RDF/corrections/correction_acoplanarity_fine_2018.root","read");
...
TFile* f_npvs=new TFile("/afs/cern.ch/work/x/xuqin/taug-2/nanoAOD/CMSSW_12_4_2/src/MyNanoAnalyzer/NtupleAnalyzerXuelong_RDF/corrections/correction_npvs_2018.root","read");
...
TFile* f_bsz=new TFile("/afs/cern.ch/work/x/xuqin/taug-2/nanoAOD/CMSSW_12_4_2/src/MyNanoAnalyzer/NtupleAnalyzerXuelong_RDF/corrections/beamspotz_2018.root","read");
TF1* f_beamspotz=(TF1*) f_bsz->Get("f_beamspotz");

TFile* f_bs=new TFile("/afs/cern.ch/work/x/xuqin/taug-2/nanoAOD/CMSSW_12_4_2/src/MyNanoAnalyzer/NtupleAnalyzerXuelong_RDF/corrections/beamspot_TF1_2018.root","read");
...
TFile *f_punt=new TFile("/afs/cern.ch/work/x/xuqin/taug-2/nanoAOD/CMSSW_12_4_2/src/MyNanoAnalyzer/NtupleAnalyzerXuelong_RDF/corrections/npu_correction_2018.root");
...
TFile *f_hsnt=new TFile("/afs/cern.ch/work/x/xuqin/taug-2/nanoAOD/CMSSW_12_4_2/src/MyNanoAnalyzer/NtupleAnalyzerXuelong_RDF/corrections/nhs_correction_2018.root");
