...
def buildCondorFile(opt,FarmDirectory):
    ...
    with open(workerFile,'w') as worker:
        ...
        worker.write('--bo $CMSSW_BASE/src/MyNanoAnalyzer/TauG2/scripts/keep_out_tautau.txt  \\\n')
...
def main():
    ...
    parser.add_option('-i', '--in',     dest='input',  help='list of input datasets',    default='/afs/cern.ch/user/x/xuqin/work/taug-2/nanoAOD/CMSSW_10_6_27/src/MyNanoAnalyzer/TauG2/data/ListSamplesDatarenanoaod2018_Tau.txt', type='string')
    parser.add_option('-o', '--out',      dest='output',   help='output directory',  default='/eos/cms/store/cmst3/group/taug2/AnalysisXuelong/ntuple_after_analyzer/tautau', type='string') #EDIT THIS
