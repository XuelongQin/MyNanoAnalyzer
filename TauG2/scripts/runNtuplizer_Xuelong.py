...
def main():
    ...
    parser.add_option('-i', '--in',     dest='input',  help='list of input datasets',    default='reNanoAODMC2016pre_GGXX.txt', type='string')
    ...
    parser.add_option('-o', '--out',      dest='output',   help='output directory',  default='/eos/cms/store/group/cmst3/group/taug2/AnalysisXuelong/ntuples_mutau_2016pre', type='string') #EDIT THIS
